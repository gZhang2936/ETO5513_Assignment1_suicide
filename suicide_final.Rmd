...
## Loading libraries
Required libraries are loaded in this section without displaying the code, warning or messages.
...
## Research question
In this mini project, we will examine and compare male and female suicide rates in different countries/regions/income groups using data obtained from 2017 to 2019. We will try to find out if suicide/self harm behavior is more prevalent in one sex and in certain countries/regions across the globe. 
...
#Filter out year 2017-2019. Drop Country code variable.
...
More specifically, "Entity" is a character variable that includes 184 countries and 10 regions/groups classified either by the geographical location of the country or by the level of income. These regions are listed below:
...
## Data summary
Table \@ref(tab:Summaryofdata) shows the mean and Standard deviation (sd) of male and female suicide rate by geographic regions of the three-year period (2017-2019).

In all geographical groups, male suicide rates were significantly higher than female suicide rates (__4 times__ at most & 1.5 times at least) and demonstrated higher variances over the years. Comparing between groups, Africa and Europe had the highest male suicide rates (18.32 and 17.94 per 100,000 male, respectively), and South-East Asian countries had a notably high female suicide rate of 7.98 per 100,000 female.
...
Male suicide rates are the highest in high (16.76) and low (15.27) income countries, followed by lower-middle income (13.11) countries. In contrast, female suicide rate is the highest in lower-middle income countries (7.07), followed by high and low income countries with a rate of 5.43 and 5.43, respectively. Of note, high and low income countries showed similar suicide rates in both sexes. 

In addition, male suicide rates in high income countries showed the highest variances among all groups.(See Table \@ref(tab:Summaryofdata2)).
...
## Visualisations
The plot below shows the global trend of suicide rate for both sexes by region over 2017 to 2019 (Figure \@ref(fig:3yeartrend)). All groups except South-East Asia showed slight reduction in overall suicide rate. The overall rates echo what we observed in \@ref(tab:Summaryofdata): Africa and Europe are the two areas where suicide is the most prevalent.
...
The set of plots below shows male vs. female suicide rates in each country in 2017, 2018, 2019. The solid line (y=x) is the equality ratio line (Figure \@ref(fig:malefemalerates)). From the plots we can clearly see:
...
## Conclusions
Notably, male suicide rates have been reported to be higher than female suicide rates in almost all countries across the globe. Compared to other countries, the south-Asian region has the highest female suicide rate of 7.98 per 100,000 female with a moderately high male suicide rate of 12.23 per 100,000 male.

Gender role is a social role which consists of behaviors or attitudes that are considered conventional or appropriate by a society based on an individual's sex. These trends might reveal how different society views each sex in their culture and its impacts on an individual's psychological health. More importantly, it is worth investigating the correlations between high suicide rates with potential causes/factors, such as diagnosed depression, available social support, cost of living, etc. to understand how we can help.
